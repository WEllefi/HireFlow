...
#this class represents an algorithm that has been evaluated for recommendation purposes
class EvaluatedAlgorithm:
    ...
    def Evaluate(self, evaluationData, doTopN, n=10, verbose=True):
            ...
            if (doTopN):
                ...
                # See how often we recommended a offer the user actually rated
                metrics["HR"] = RecommenderMetrics.HitRate(topNPredicted, leftOutPredictions)   
                # See how often we recommended a offer the user actually liked
